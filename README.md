...
Через меншу складність жадібний алгоритм зазвичай працює швидше за динамічний. Він не потребує розгляду всіх потенційних комбінацій монет для кожної суми, що значно зменшує час виконання.  Динамічний  вимагає обчислення значень для кожної суми від 0 до бажаної суми. В результаті час виконання може збільшуватися пропорційно розміру вхідних даних.